...
public class _02_DatePickerUtility_1 {
	...
	public static void main(String[] args) {
		...
		//selectFutureOrCurrentDate(driver, year, month, day);
		selectPastDate(driver, year, month, day);
	}
	
	//selecting future date
	public static void selectFutureOrCurrentDate(WebDriver driver, String year, String month, String day) {
		while(true) {
